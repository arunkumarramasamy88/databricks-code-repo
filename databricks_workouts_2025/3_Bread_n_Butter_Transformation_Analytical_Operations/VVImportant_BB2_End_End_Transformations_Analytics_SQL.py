...
# MAGIC %md
# MAGIC End of Spark BB2 DSL & SQL (We can say, we are Pyspark (SQL+DSL) - Data Transformation & Analytics  to become Data Engineer + Data Analyst) under the platform of Databricks
