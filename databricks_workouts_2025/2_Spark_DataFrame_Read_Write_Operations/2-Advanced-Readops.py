...
#1. Collect the data as it is from the source
#2. Convert into orc/parquet format and write to the target by appending the data on a regular interval
#Performance or Functionality? functionality first...
day1df=spark.read.csv("/Volumes/workspace/default/volumewd36/day1.txt",header=True,inferSchema=True,samplingRatio=.3)
